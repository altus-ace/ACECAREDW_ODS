...
CREATE VIEW adi.MpulseMt_Valid
...
AS  
    /* purpose: gets validation state of MPulse Adi data
	   ...
	   */
    SELECT m.MpulseMtUrn,m.ClientMemberKey, m.ClientKey, m.Ace_ID, m.PhoneNumber, 'MIssing campaign ID'CampaignID
