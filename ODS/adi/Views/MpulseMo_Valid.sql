CREATE VIEW adi.MpulseMo_Valid
AS
    /* purpose: gets validation state of MPulse Adi data
	   ...
	   */
SELECT m.MpulseMoUrn, m.ClientMemberKey, m.ClientKey, m.Ace_ID, m.PhoneNumber, 'MIssing campaign ID' CampaignID
