...
-- =============================================
CREATE PROCEDURE [adi].[ImportMbrUhcNewMembers]
( 	
    @mbrFName varchar(75) ,
	@mbrMName varchar(75),
	@mbrLName varchar(75) ,
...
--	    LastName = @LastName
 ...
 --   WHERE SubscriberID = @SubscriberID
	...
	BEGIN
    -- Insert statements 
	 INSERT INTO [adi].[MbrUhcNewMembers]
   (
	[mbrFName],
	[mbrMName] ,
	[mbrLName] ,
	...
	--[LoadDate] [date],
	GETDATE(),
	--CONVERT(DATE, Substring(@SourceFileName, CHARINDEX('NewMember', @SourceFileName) + 10, 7) + '-01'),
	--@DataDate
	--Convert(DATE, Substring(@SourceFileName, CHARINDEX('New Member', @SourceFileName) + 11, 6) + '01'),
	GETDATE(),
	GETDATE(),
	-- [CreateDate] [,
	@CreateBy ,
