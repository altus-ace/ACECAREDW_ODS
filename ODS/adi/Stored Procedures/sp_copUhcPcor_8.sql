...
-- =============================================
CREATE PROCEDURE [adi].[sp_copUhcPcor_8](
	...
	@CDC_CompDiabetesCareHbA1cTesting varchar(3),
	...
	@MPM_AnnualMonitoringForPatientsOnPersistentMedicationsACEInhibitorsOrARBs varchar(3),
	@MPM_AnnualMonitoringForPatientsOnPersistentMedicationsDiuretics varchar(3),
	@AdherenceToAntipsychoticMedicationsForIndividualsWithSchizophreniaAges19_64 varchar(3),
	@AAP_AdultsAccesstoPreventiveAmbulatoryHealthServices varchar(3),
	@CHL_ChlamydiaScreeningInWomen varchar(3),
	@COA_CareForOlderAdults_MedicationReview varchar(3),
