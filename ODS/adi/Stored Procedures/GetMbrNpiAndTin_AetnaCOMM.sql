...
CREATE PROCEDURE [adi].[GetMbrNpiAndTin_AetnaCOMM] (@LoadDate DATE, @RowStatus INT,@ClientKey INT) -- [adi].[GetMbrNpiAndTin_AetnaCOMM]'2021-05-20',0,9

AS
					-- DECLARE @LoadDate DATE = '2021-05-20' DECLARE @RowStatus INT = 0 DECLARE @ClientKey INT = 9
