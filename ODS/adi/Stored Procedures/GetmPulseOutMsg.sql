...
CREATE PROCEDURE [adi].[GetmPulseOutMsg]
...
BEGIN
	...
	SET NOCOUNT ON;
    DECLARE @Date DATE
	SET @Date = CONVERT(DATE, @FilterDate)
...
(
	...
	FROM adi.mpulseacemessages where CENTRAL_DATE_TIME is not null and  CENTRAL_DATE_TIME > @Date
) AS x
