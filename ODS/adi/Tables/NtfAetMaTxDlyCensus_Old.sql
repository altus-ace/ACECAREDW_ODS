CREATE TABLE [adi].[NtfAetMaTxDlyCensus_Old] (
    [NtfAetDlyCensusKey]              INT           IDENTITY (1, 1) NOT NULL,
    [OriginalFileName]                VARCHAR (100) NOT NULL,
    [SourceFileName]                  VARCHAR (100) NOT NULL,
    [LoadDate]                        DATE          NOT NULL,
    [DataDate]                        DATE          NOT NULL,
    [CreatedDate]                     DATE          CONSTRAINT [DF_NtfAetTxMaDlyCensus_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [CreatedBy]                       VARCHAR (50)  CONSTRAINT [DF_NtfAetTxMaDlyCensus_CreatedBy] DEFAULT (suser_sname()) NULL,
