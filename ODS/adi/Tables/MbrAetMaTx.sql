CREATE TABLE [adi].[MbrAetMaTx] (
    [mbrAetMaTxKey]                               INT           IDENTITY (1, 1) NOT NULL,
    [SrcFileName]                                 VARCHAR (100) NOT NULL,
    [LoadDate]                                    DATE          NOT NULL,
    [DataDate]                                    DATE          NOT NULL,
    [CreatedDate]                                 DATETIME      CONSTRAINT [DF_adiMbrAetMaTx_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [CreatedBy]                                   VARCHAR (50)  CONSTRAINT [DF_adiMbrAetMaTx_CreatedBy] DEFAULT (suser_sname()) NOT NULL,
    [LastUpdatedDate]                             DATETIME      CONSTRAINT [DF_adiMbrAetMaTx_LastUpdatedDate] DEFAULT (getdate()) NOT NULL,
    [LastUpdatedBy]                               VARCHAR (50)  CONSTRAINT [DF_adiMbrAetMaTx_LastUpdatedBy] DEFAULT (suser_sname()) NOT NULL,
    ...
    [MbrLoadStatus]                               TINYINT       DEFAULT ((0)) NOT NULL,
    [PLAN_ID]                                     VARCHAR (5)   NULL,
    [Hcontract_PBP_ID]                            VARCHAR (10)  NULL,
    PRIMARY KEY CLUSTERED ([mbrAetMaTxKey] ASC)
);


GO
CREATE NONCLUSTERED INDEX [ndx_MbrAetMaTx_MbrLoadStatus]
    ON [adi].[MbrAetMaTx]([MbrLoadStatus] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_adiMbrAetTxMa_EffMonth]
    ON [adi].[MbrAetMaTx]([EffectiveMonth] ASC)
