...
CREATE PROCEDURE [adw].[z__PdwUhcMembers_UhcModel]
AS 
BEGIN 
	   ...
	   INSERT INTO [dbo].[Uhc_MembersByPcp](
        ...
        SELECT 
		    a.MEMB_FIRST_NAME
    		  ...
    		  , a.MEDICARE_NO
    		  , a.AGE
    		  , CONVERT(DATE,a.DATE_OF_BIRTH) AS DATE_OF_BIRTH
    		  , a.MEMB_GENDER
    		  , '' AS	MEMB_LANGUAGE
    		  ...
    		  --, CONVERT(DATE,CONVERT(VARCHAR(9),a.ORIGINAL_EFFECTIVE_DATE,102)) AS ORIGINAL_EFFECTIVE_DATE
			  , CONVERT(DATE,a.MBR_EFFECTIVE_DATE) AS MEMBER_ORG_EFF_DATE
			  , CONVERT(DATE,a.CONT_EFFECTIVE_DATE) AS MEMBER_CONT_EFF_DATE
			  , CONVERT(DATE,a.ORIGINAL_EFFECTIVE_DATE) AS MEMBER_CUR_EFF_DATE
    		  , a.PROVIDER_NPI
    		  , a.PROV_FNAME
    		  , a.PROV_LNAME
    		  , a.PROV_PHONE
