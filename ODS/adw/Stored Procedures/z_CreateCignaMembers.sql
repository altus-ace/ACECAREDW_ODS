...
END
/***
EXEC adw.z_CreateCignaMembers '2021-01-01','2021-05-31','2021-06-03'

SELECT * FROM dbo.z_tmp_AttribMembers			WHERE	ClientKey IN (12) AND EffectiveAsOfDate			= '2021-06-03'
SELECT * FROM dbo.z_tmp_AttribMembers_Failed WHERE	ClientKey IN (12)	AND EffectiveAsOfDate			= '2021-06-03'
