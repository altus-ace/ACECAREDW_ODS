...
CREATE PROCEDURE [adw].[Pdw_ExpAhs_AhsEligiblity_CignaMa]
    --(@ClientKey INT )
AS 
BEGIN
	/* objective 
	...
	--SELECT * from ast.DatesToProcess_AhsExpElig 
	--SELECT * from ast.AhsExpElig_MbrCsPlanInfo i where i.CMK = '32194670'
	...
	--SELECT * from ast.DatesToProcess_AhsExpElig 
	--SELECT * from ast.AhsExpElig_MbrCsPlanInfo i where i.cmk = '32194670'
	--SELECT * FROM ast.AhsExpEligiblity e   where e.clientMemberKey = '32194670'ORDER BY e.ClientMemberKey, e.Exp_START_DATE asc
	--SELECT MAX(ast.Exp_END_DATE) FROM ast.AhsExpEligiblity ast WHERE ast.StgRowStatus = 'Loaded'
