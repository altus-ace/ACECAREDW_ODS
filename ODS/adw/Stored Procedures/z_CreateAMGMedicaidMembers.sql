...
***/
CREATE PROCEDURE adw.z_CreateAMGMedicaidMembers
...
DECLARE @ClientKey			VARCHAR(5)	= '22'
...
WHERE p.' + @ClientMemberKey + ' IS NOT NULL 
   ...
   AND p.' + @DataDate + ' BETWEEN p.EffectiveDate              AND p.TerminationDate
	AND c.PG_ID = ' + char(39) + 'TX000424' + char(39) + ' AND c.PRDCTSL = ' + char(39) + 'MDCD' + char(39) + '
) m WHERE rn = 1
UPDATE ' + @TgtTblName + '
...
END
/***
EXEC adw.z_CreateAMGMedicaidMembers '2020-1-01','2021-05-31','2021-06-03'

SELECT * FROM dbo.z_tmp_AttribMembers			WHERE	ClientKey IN (22) AND EffectiveAsOfDate			= '2021-06-03' 
SELECT * FROM dbo.z_tmp_AttribMembers_Failed WHERE	ClientKey IN (22)	AND EffectiveAsOfDate			= '2021-06-03'

SELECT * FROM ACECAREDW.adw.tvf_AllClient_ProviderRoster (22,getdate(),1)
***/
