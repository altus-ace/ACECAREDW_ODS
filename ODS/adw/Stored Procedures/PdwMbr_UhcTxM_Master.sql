...
CREATE PROCEDURE [adw].[PdwMbr_UhcTxM_Master]
    @LoadType Char(1)
    , @LoadDate Date    	
AS 
   /* /
...
/**/
    ...
    /* Load Stging tables */	    
    EXEC ast.MbrPst2MbrUhcTxMbrDetail  @LoadDate, @InsertCount = @Stg2CountMbrDet	OUTPUT; 
    EXEC ast.MbrPst2MbrUhcMTxMbrPhnAdd @LoadDate, @InsertCount = @Stg2CountMbrPhnAdd OUTPUT;
    ...
    /* DO TRANSFORMS */
    -- get NPI for PCP
    EXEC ast.mbrPstTransform_GetMbrNpiFromProviderIdUhc @LoadDate;
    EXEC ast.mbrPstTransform_GetEthnicityUhc @LoadDate;
    EXEC ast.MbrPstTransform_GetPlanDetailsUhc @LoadDate;
    -- SET CONTRACTED TIN in stg. 
