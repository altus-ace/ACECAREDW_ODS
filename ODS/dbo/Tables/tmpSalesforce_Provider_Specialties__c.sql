CREATE TABLE [dbo].[tmpSalesforce_Provider_Specialties__c] (
    [Id]                         VARCHAR (50)  NULL,
    ...
    [Specialtiy_Type__c]         VARCHAR (50)  NULL,
    [Provider_Name__c]           VARCHAR (100) NULL,
    [Specialty_Sub_Specialty__c] VARCHAR (150) NULL,
    [Speciality_Name_CAQH__c]    VARCHAR (150) NULL,
    [Speciality_Name__c]         VARCHAR (150) NULL,
