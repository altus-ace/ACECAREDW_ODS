CREATE VIEW [dbo].[vw_AH_PE_AET_Careopps]
AS
...
(
    ...
    WHERE co.CopStgLoadStatus = 0 AND co.AceiArbAdherence = 'Y'
    ...
    SELECT DISTINCT
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.[Breast ScreeningCompliance], 1))) = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.ColorectalScreeningCompliance, 1))) = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.DiabetesEyeExam, 1))) = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.DiabetesNephropathyScreening, 1))) = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.DiabetesLdlControl, 1))) = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.DiabetesMedicationAdherence, 1))) = 'Y'
    ...
    SELECT DISTINCT
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.DiabetesControlledHbA1c, 1))) = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND LTRIM(RTRIM(LEFT(co.StatinUseInDiabetics, 1))) = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.StatinMedicationAdherence = 'Y'
    ...
    SELECT DISTINCT
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.OsteoporosisManagement = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.RheumatoidArthritisManagement = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.AdultBMIAssessment = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.LastOfficeVisit = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.[OfficeVisits-Chronic1stHalf] = '0'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.[Office Visits-Chronic2ndHalf] = '0'
    ...
    SELECT DISTINCT
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.AnnualFluVaccine = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.ControllingHighBloodPressure = 'N'
    UNION
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.MedicationReconciliationPostDischarge = 'N'
	 UNION
	 /* Added a new measure. 
	 **It will return the diabetesHba1C level WHERE co.CopStgLoadStatus = 0 AND row is not null and is greater than 8.5
	 */
    SELECT DISTINCT
           co.MemberID,
           ...
           co.tin
    FROM [adi].[copAetMaCareopps] co
    WHERE co.CopStgLoadStatus = 0 AND co.[DiabetesHba1C Level]<> ''
