...
create VIEW [dbo].[vw_ACE_Validation_Chk_AET_MbrplanChangembrs]
AS
select distinct  ss.cur_mbr,ss.cur_plan,ss.old_plan,m.ClientMemberKey,mp.EffectiveDate,mp.ExpirationDate,mp.ProductSubPlan from (
...
LEFT JOIN ACECAREDW.adw.mbrplan mp ON mp.mbrMemberKey = m.mbrMemberKey and GETDATE() between mp.EffectiveDate and mp.ExpirationDate
