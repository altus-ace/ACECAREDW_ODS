CREATE   VIEW [dbo].[yy_vw_AllClient_ProviderRoster_LoadFctSource_Old]
AS    
    ...
    SELECT *, 	   -- Ignore  clients --4 UHC-MI, --5 UHC-CP-PCPi, --6 CCACO --7 OKC, --8	ECAP, --13 mpulse, --14 Ace
	 CASE WHEN (PR.HealthPlan = 'AETNA'	   and 	PR.LOB = 'Commercial')					THEN  9	  --9	Aetna Comercial	AetCom
		  WHEN (PR.HealthPlan = 'AETNA'	   and 	PR.LOB = 'Medicare Advantage')			THEN  3	  --3	Aetna	Aetna
		  ...
		  WHEN (PR.HealthPlan = 'CIGNA'	   and 	PR.LOB = 'Medicare Advantage')			THEN  12	  --12	Cigna MA	Cigna_MA
