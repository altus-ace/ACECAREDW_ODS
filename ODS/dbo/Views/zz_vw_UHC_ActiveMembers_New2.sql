...
CREATE VIEW [dbo].[zz_vw_UHC_ActiveMembers_New2]
AS
	...
	Inner join adw.A_ALT_MemberPlanHistory mp on mp.[Client_Member_ID]=umPCP.uhc_subscriber_id
	 and getdate() between mp.startdate and mp.stopdate
