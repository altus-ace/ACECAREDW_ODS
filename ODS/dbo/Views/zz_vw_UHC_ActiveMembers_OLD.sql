...
CREATE VIEW [dbo].[zz_vw_UHC_ActiveMembers_OLD]
AS
     SELECT
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 89
         ...
         Width = 1500
         Width = 1500
         Width = 150', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'zz_vw_UHC_ActiveMembers_OLD';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'0
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'zz_vw_UHC_ActiveMembers_OLD';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'zz_vw_UHC_ActiveMembers_OLD';
