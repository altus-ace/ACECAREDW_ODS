...
create VIEW [dbo].[vw_AH_PE_UHC_Careopps_UhcMissingCoExport]
AS
(
/*
    GET ACTIVE_Members
...
AND cop.QMDate = '2020-12-18' and cop.CreateDate > ='02/23/2021'
    		  		   ) cop
    		  	WHERE cop.arn = 1			
    		  	)AS CareOp
