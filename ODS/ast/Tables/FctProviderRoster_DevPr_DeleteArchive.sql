CREATE TABLE [ast].[FctProviderRoster_DevPr_DeleteArchive] (
    ...
    [TinClientKey]           INT           NOT NULL,
    [TinLob]                 VARCHAR (50)  NOT NULL,
    [TinHealthPlan]          VARCHAR (50)  NOT NULL,
    [TinHpEffDate]           DATE          NOT NULL,
    [TinHpExpDate]           DATE          NOT NULL,
    [PrvdrTin]               VARCHAR (12)  NOT NULL,
    [PrvdrClientKey]         INT           NOT NULL,
    [PrvdrLOB]               VARCHAR (50)  NOT NULL,
    [PrvdrHealthPlan]        VARCHAR (50)  NOT NULL,
    [PrvdrHpEffDate]         DATE          NOT NULL,
    [PrvdrHpExpDate]         DATE          NOT NULL,
